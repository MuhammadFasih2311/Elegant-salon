...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO serve (category, label, price, image) 
            VALUES ('$category', '$label', '$price', '$image_name')";

    if (mysqli_query($conn, $sql)) {
        header("Location: admin_dashboard.php?msg=" . urlencode("Service added successfully!"));
        exit();
    } else {
...
<div class="container my-5 flex-grow-1">
  <div class="form-card">
    <h3 class="text-warning mb-4 text-center" data-aos="fade-down">➕ Add New Product</h3>
    <form method="POST" enctype="multipart/form-data" class="row g-3">
      <div class="col-md-6" data-aos="fade-right">
        <label class="form-label">Category</label>
        <input type="text" name="category" class="form-control" required pattern="[A-Za-z0-9\s\-\&\,\.\'\(\)\+]+"
       title="Alphabets, numbers & limited symbols (-, &, ., ', (, ), +, ,) allowed" maxlength="30">
      </div>
      <div class="col-md-6" data-aos="fade-left">
        <label class="form-label">Label (Service Name)</label>
        <input type="text" name="label" class="form-control" required maxlength="30">
      </div>
      <div class="col-md-6" data-aos="fade-right">
      ...
      <div class="col-12 text-center" data-aos="zoom-in-up">
        <button type="submit" name="submit" class="btn btn-warning px-5" data-aos="fade-right">Add Product</button>
...
<script>
  ...
  // ✅ Category Validation (alphabets only)
