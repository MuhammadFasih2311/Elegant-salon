...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!preg_match('/^[0-9]{11}$/', $phone)) {
        $error = "⚠️ Phone must be exactly 11 digits.";
    } else {
...
<head>
  ...
  <title>Edit Profile - Elegant Salon</title>
  ...
  <style>
    ...
    .dark-mode small.text-muted { color:#ccc !important; }
...
<body class="d-flex flex-column min-vh-100"> <!-- 👈 same as profile page -->
  ...
  <main class="flex-grow-1"> <!-- 👈 wrapper -->
    <section class="hero my-4" data-aos="fade-down">
            ...
            <form method="POST">
              <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" required 
                  value="<?= htmlspecialchars($user['name']); ?>" maxlength="30">
              </div>
              <div class="mb-3">
